...
export default function Territorio1() {
  ...
  const dados = [
...

    {
      ...
      descricao:
        "A onça-parda, também conhecida como puma ou leão-da-montanha, é um grande felino encontrado nas Américas. É um predador ágil e adaptável, capaz de viver em uma variedade de habitats, desde florestas até montanhas. A onça-parda é conhecida por sua pelagem uniforme e seu comportamento solitário.",
    },
...

    {
      ...
      descricao:
        "Os cagados são répteis aquáticos encontrados em várias regiões do mundo. Eles são conhecidos por sua carapaça dura e comportamento semi-aquático. Os cagados são herbívoros e desempenham um papel importante na manutenção dos ecossistemas aquáticos, ajudando a controlar o crescimento de plantas aquáticas.",
    },
...

    {
      ...
      descricao:
        "Os flamingos são aves aquáticas conhecidas por sua plumagem rosa vibrante e pernas longas. Eles são encontrados em regiões tropicais e subtropicais, onde se alimentam de pequenos crustáceos e algas. Os flamingos são conhecidos por seus comportamentos sociais, formando grandes colônias.",
    },
